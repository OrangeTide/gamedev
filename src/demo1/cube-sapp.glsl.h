...
/*
    ...
    Cmdline: sokol-shdc --input cube-sapp.glsl --output cube-sapp.glsl.h --slang glsl330 --genver 1 --errfmt gcc --format sokol --bytecode --module demo1 --reflection

    Overview:

        Shader program 'cube':
            Get shader desc: demo1_cube_shader_desc(sg_query_backend());
            Vertex shader: vs
                Attribute slots:
                    ATTR_demo1_vs_position = 0
                    ATTR_demo1_vs_color0 = 1
                Uniform block 'vs_params':
                    C struct: demo1_vs_params_t
                    Bind slot: SLOT_demo1_vs_params = 0
            Fragment shader: fs


    Shader descriptor structs:

        sg_shader cube = sg_make_shader(demo1_cube_shader_desc(sg_query_backend()));
    ...
    Vertex attribute locations for vertex shader 'vs':
        ...
        sg_pipeline pip = sg_make_pipeline(&(sg_pipeline_desc){
            .layout = {
                .attrs = {
                    [ATTR_demo1_vs_position] = { ... },
                    [ATTR_demo1_vs_color0] = { ... },
                },
            },
            ...});
    ...
    Bind slot and C-struct for uniform block 'vs_params':
        ...
        sg_apply_uniforms(SG_SHADERSTAGE_[VS|FS], SLOT_demo1_vs_params, &SG_RANGE(vs_params));
...
#include <stddef.h>
  ...
  #endif
#endif
#define ATTR_demo1_vs_position (0)
#define ATTR_demo1_vs_color0 (1)
#define SLOT_demo1_vs_params (0)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct demo1_vs_params_t {
    hmm_mat4 mvp;
} demo1_vs_params_t;
#pragma pack(pop)
/*
...
*/
static const char demo1_vs_source_glsl330[263] = {
...
*/
static const char demo1_fs_source_glsl330[114] = {
...
#endif
static inline const sg_shader_desc* demo1_cube_shader_desc(sg_backend backend) {
  if (backend == SG_BACKEND_GLCORE33) {
    ...
    if (!valid) {
      ...
      desc.vs.source = demo1_vs_source_glsl330;
      desc.vs.entry = "main";
      ...
      desc.fs.source = demo1_fs_source_glsl330;
      desc.fs.entry = "main";
      desc.label = "demo1_cube_shader";
    }
    return &desc;
  }
  return 0;
}
static inline int demo1_cube_attr_slot(const char* attr_name) {
  (void)attr_name;
...
static inline int demo1_cube_image_slot(sg_shader_stage stage, const char* img_name) {
  (void)stage; (void)img_name;
  return -1;
}
static inline int demo1_cube_uniformblock_slot(sg_shader_stage stage, const char* ub_name) {
...
static inline size_t demo1_cube_uniformblock_size(sg_shader_stage stage, const char* ub_name) {
  (void)stage; (void)ub_name;
  if (SG_SHADERSTAGE_VS == stage) {
    if (0 == strcmp(ub_name, "vs_params")) {
      return sizeof(demo1_vs_params_t);
    }
  }
  return 0;
}
static inline int demo1_cube_uniform_offset(sg_shader_stage stage, const char* ub_name, const char* u_name) {
...
static inline sg_shader_uniform_desc demo1_cube_uniform_desc(sg_shader_stage stage, const char* ub_name, const char* u_name) {
  (void)stage; (void)ub_name; (void)u_name;
