...
/*
    ...
    Cmdline: sokol-shdc --input triangle-sapp.glsl --output triangle-sapp.glsl.h --slang glsl330 --genver 5 --errfmt gcc --format sokol --bytecode --module demo1 --reflection

    Overview:

        Shader program 'triangle':
            Get shader desc: demo1_triangle_shader_desc(sg_query_backend());
            Vertex shader: vs
                Attribute slots:
    ...
    Shader descriptor structs:
        ...
        sg_shader triangle = sg_make_shader(demo1_triangle_shader_desc(sg_query_backend()));
...
*/
static const char demo1_vs_source_glsl330[173] = {
...
#endif
static inline const sg_shader_desc* demo1_triangle_shader_desc(sg_backend backend) {
  if (backend == SG_BACKEND_GLCORE33) {
    ...
    if (!valid) {
      ...
      desc.fs.entry = "main";
      desc.label = "demo1_triangle_shader";
    }
    return &desc;
  }
  return 0;
}
static inline int demo1_triangle_attr_slot(const char* attr_name) {
  (void)attr_name;
...
static inline int demo1_triangle_image_slot(sg_shader_stage stage, const char* img_name) {
  (void)stage; (void)img_name;
  return -1;
}
static inline int demo1_triangle_uniformblock_slot(sg_shader_stage stage, const char* ub_name) {
  (void)stage; (void)ub_name;
  return -1;
}
static inline size_t demo1_triangle_uniformblock_size(sg_shader_stage stage, const char* ub_name) {
  (void)stage; (void)ub_name;
  return 0;
}
static inline int demo1_triangle_uniform_offset(sg_shader_stage stage, const char* ub_name, const char* u_name) {
  (void)stage; (void)ub_name; (void)u_name;
  return -1;
}
static inline sg_shader_uniform_desc demo1_triangle_uniform_desc(sg_shader_stage stage, const char* ub_name, const char* u_name) {
  (void)stage; (void)ub_name; (void)u_name;
